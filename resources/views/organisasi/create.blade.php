...
<div class="container">
<h1>{{ __('Organisasi') }}</h1>
<form method="post" action="{{ url('/organisasi/store') }}">
@csrf
<div class="row mb-3">
...
name="nama_organisasi" value="{{ old('nama_organisasi') }}"/>
</div>
</div>

<div class="row mb-3">
<label for="nama_ketua" class="col-3 col-form-label">Nama Ketua Organisasi</label>
<div class="col-9">
